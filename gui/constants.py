...
ALLOWED_ENEMY_IDS = {232315, 672105, 682205, 703405, 201405, 163205, 713405, 722305, 652105, 152205, 161418, 242305, 361215, 293405}

# 当期敌方数量（取JSON文件最后添加的N个为当期敌方，其余为往期）
# 当期敌方：361215（惨禍：一条白奈）、293405（惨禍：レイラ・ジェンキンス）
